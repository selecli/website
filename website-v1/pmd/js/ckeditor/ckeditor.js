...
(function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], i = 0; i < c.length; i++) if (e) for (var g = 0; g < e.length; g++) b.push([a, c[i], e[g]].join("-"));
    ...
    !0, {
        ...
        function a(a, b) {
            ...
            if (this.current) d = this.current[n](false, k, h);
                ...
                if (a) d.type == CKEDITOR.NODE_ELEMENT && (d = e > 0 ? d.getChild(e - 1) : h(d, true) === false ? null: d.getPreviousSourceNode(true, k, h));
                else {
                    d = f;
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        for (; k;) {
                            ...
                            if (k.type == CKEDITOR.NODE_COMMENT) k = k.getPrevious();
                                ...
                                if (k.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    l = k.getText();
                                    if (d.test(l)) k = null;
                                    else for (var D = k.$.getElementsByTagName("*"), J = 0, z; z = D[J++];) if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
                                        k = null;
                                        break
                                    }
                                    k && (o = !!l.length)
                    ...
                    if (o.type == CKEDITOR.NODE_TEXT) if (CKEDITOR.tools.trim(o.substring(D)).length) r = true;
                    else {
                        r = !o.getLength();
                        if (D == o.getLength()) {
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    h = 1,
                    i = 1;
                    if (f && f.type == CKEDITOR.NODE_TEXT) if (j) if (j >= f.getLength()) d.setStartAfter(f);
                    else {
                        d.setStartBefore(f);
                        h = 0
                    ...
                    d.guard = function(b, d) {
                        if (k(b)) return true;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(n) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return false; ! d && b.type == CKEDITOR.NODE_ELEMENT && (n = b);
                        return true
                    };
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; j;) {
                    ...
                    k = 0;
                    if (E) j.type == CKEDITOR.NODE_TEXT && f.test(j.getText()) && (E = 0);
                    else {
                        var n = j.getName();
                ...
                if (!this._.nextNode) this._.nextNode = s || e.equals(q) || !q ? null: this._getNextSourceNode(e, 1, q);
                return e
            },
            _getNextSourceNode: function(a, b, c) {
                ...
                for (var e = this.range.root,
                a = a.getNextSourceNode(b, null, f); ! d(a);) a = a.getNextSourceNode(b, null, f);
                return a
            }
        };
    ...
    CKEDITOR.config = {
        ...
        function a(a, b, c, d, f) {
            ...
            d = a.length; c < d; ++c) {
                ...
                if (e.elements === true || e.elements === null) f[n ? "unshift": "push"](e);
                    ...
                    j = e.elements;
                    delete e.elements;
                    for (D in j) if (b[D]) b[D][n ? "unshift": "push"](e);
                    else b[D] = [e]
                }
            }
        }
        ...
        function k(a, b, c) {
            var d = a.name;
            if (J.$empty[d] || !a.children.length) if (d == "hr" && b == "br") a.replaceWith(v());
            else {
                a.parent && c.push({
                    check: "it",
                    el: a.parent
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                null, true);
                e.length && (x = true);
                for (var o, a = [], d = H[d || (this.editor ? this.editor.enterMode: CKEDITOR.ENTER_P)], p; c = e.pop();) c.type == CKEDITOR.NODE_ELEMENT ? k(c, d, a) : c.remove();
                for (; o = a.pop();) {
                    c = o.el;
                    if (c.parent) {
            ...
            transform: function(a, b) {
                if (typeof b == "string") a.name = b;
                    ...
                    for (e in f) if (e == "class") {
                        c = a.classes.join("|");
                        for (n = f[e].split(/\s+/); k = n.pop();) c.indexOf(k) == -1 && a.classes.push(k)
        ...
        return {
            load: function(b, c, f, d) {
                ...
                if (l === 0) m(true);
                    ...
                    var t = function(a, b) { (b ? i: g).push(a);
                        if (--l <= 0) {
    ...
    CKEDITOR.event.implementOn(CKEDITOR.ui); (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            destroy: function(a) {
                this.fire("beforeDestroy"); ! a && t.call(this);
                this.editable(null);
                this.filter.destroy();
                delete this.filter;
                ...
                h; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (h) h.push(c[0]);
                        ...
                        if (!/="/.test(f)) {
                            ...
                            this.onTagOpen(f, l, c); ! h && CKEDITOR.dtd.$cdata[f] && (h = [])
                        }
                ...
                if (a(f)) j.push(f);
                    ...
                    if (d == "br") u.push(f);
                        ...
                        for (;;) {
                            ...
                            if (!f.isUnknown && !v.isUnknown && !l[d]) if (v.isOptionalClose) p.onTagClose(h);
                                ...
                                v = h
                            } else if (d in CKEDITOR.dtd.$listItem && !y(d, h)) p.onTagOpen(d == "li" ? "ul": "dl", {},
                            0, 1);
    ...
    "use strict"; (function() {
        ...
        a.prototype = {
            ...
            execOnName: function(a, c) {
                ...
                e = d.length,
                l; c && f < e; f++) {
                    l = d[f]; ! (a.nonEditable && !l.options.applyToAll || a.nestedEditable && l.options.excludeNestedEditable) && (c = c.replace(l.value[0], l.value[1]))
                }
                return c
            }
        }
                ...
                return function(e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (k) for (w(k, 1) && j.push(k); k;) {
                            if (d(k) && (x = c(k)) && w(x)) if ((r = c(x)) && !d(r)) j.push(x);
                            else {
                                n(o).insertAfter(x);
                                x.remove()
                            }
                        ...
                        if (j = (typeof f == "function" ? f(e) : f) !== false) if (!o && !CKEDITOR.env.needsBrFiller && e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) j = false;
    ...
    CKEDITOR.config.startupMode = "wysiwyg"; (function() {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    var r, g;
                    if (f) for (; (r = b.getCommonAncestor(0, 1)) && (g = CKEDITOR.dtd[r.getName()]) && (!g || !g[e]);) if (r.getName() in CKEDITOR.dtd.span) b.splitElement(r);
                ...
                setup: function() {
                    ...
                    function() {
                        var b = this.getData();
                        this.is("textarea") || a.config.ignoreEmptyParagraph !== false && (b = b.replace(t,
                        function(a, b) {
                            return b
                        }));
                        a.setData(b, null, 1)
                        ...
                        function(b) {
                            ...
                            if (c in k) {
                                ...
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (f = b.getSelectedElement()) || (f = d(b))) {
                                    ...
                                    a.fire("saveSnapshot");
                                    e = 1
                                } else if (g.collapsed) if ((i = h.block) && (l = i[c ? "getPrevious": "getNext"](s)) && l.type == CKEDITOR.NODE_ELEMENT && l.is("table") && g[c ? "checkStartOfBlock": "checkEndOfBlock"]()) {
                                    a.fire("saveSnapshot");
                                    ...
                                    a: {
                                        ...
                                        if (f) if (d[c ? "checkStartOfBlock": "checkEndOfBlock"]()) if (!d.moveToClosestEditablePosition(f, !c) || !d.collapsed) e = false;
                                            ...
                                            if ((d = d.startPath().block) && (!d || !d.contains(f))) {
                                                a.fire("saveSnapshot");
                                                var i; (i = (c ? d: f).getBogus()) && i.remove();
                                                e = a.getSelection();
                                                i = e.createBookmarks(); (c ? f: d).moveChildren(c ? d: f, false);
        ...
        var p = function() {
            ...
            return function(o, z, p) {
                ...
                if (!w.checkReadOnly()) {
                    ...
                    A = B.createBookmark(); (C = A.startNode.getPrevious(c)) && a(C) && e(C) && H.push(C); (C = A.startNode.getNext(c)) && a(C) && e(C) && H.push(C);
                    ...
                    if (A) {
                        ...
                        for (n(x, t); A < x.length; A++) {
                            ...
                            if (q) H = A > 0;
                                ...
                                if (F.lastNotAllowed && A < x.length - 1) { (S = s ? C: S) && t.setEndAt(S, CKEDITOR.POSITION_AFTER_START);
                                    B = 0
                                }
                                t.collapse()
                            }
                    ...
                    for (T = K.createBookmark(); I = z.zombies.pop();) if (I.getParent()) {
                        Q = K.clone();
        ...
        function(b) {
            ...
            function() {
                ...
                CKEDITOR.env.webkit && k.attachListener(f, "keydown",
                function(a) {
            ...
            getRanges: function() {
                ...
                function() {
                    ...
                    var b = function(b, c) {
                        ...
                        f, g, h = b.duplicate(), k = 0, i = e.length - 1, j = -1, A, x; k <= i;) {
                            j = Math.floor((k + i) / 2);
                            f = e[j];
    ...
    CKEDITOR.STYLE_OBJECT = 3; (function() {
            ...
            if (b.collapsed) {
                ...
                for (o.getPosition(p) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o;) {
                    ...
                    if (o.equals(p)) {
                        ...
                        if (t && k && CKEDITOR.dtd.$block[s]) for (var v = o,
                        u = c(v), z = void 0, D = u.length, E = 0, v = D && new CKEDITOR.dom.range(v.getDocument()); E < D; ++E) {
                            var z = u[E],
                        ...
                        if (u) if ((u = o.getParent()) && ((u.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(u))) {
                            ...
                            if (s == CKEDITOR.NODE_TEXT || t || s == CKEDITOR.NODE_ELEMENT && !o.getChildCount()) {
                                for (var s = o,
                                U; (i = !s.getNext(J)) && (U = s.getParent(), l[U.getName()]) && (U.getPosition(n) | B) == B && (!g.childRule || g.childRule(U));) s = U;
                                q.setEndAfter(s)
                            }
                        } else i = true;
                        else i = true;
                    ...
                    if (i && q && !q.collapsed) {
                        for (var i = j(this, d), t = i.hasAttributes(), r = q.getCommonAncestor(), s = {},
                        u = {},
                        z = {},
                        D = {},
                        O, R, X; i && r;) {
                            if (r.getName() == f) {
                                for (O in g.attributes) if (!D[O] && (X = r.getAttribute(R))) i.getAttribute(O) == X ? u[O] = 1 : D[O] = 1;
        ...
        function f(a) {
            var b = a.getEnclosedNode() || a.getCommonAncestor(false, true); (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) && !a.isReadOnly() && u(a, this)
        }
        function d(a) {
                    ...
                    getNextRange: function(h) {
                        ...
                        if (l && a.length > 1) {
                            ...
                            if (h) for (var g = 0; a[d + g + 1];) {
                                ...
                                h = 0,
                                i = m.getById(e[g].endNode), m = m.getById(e[g + 1].startNode);;) {
...
*/
    ...
    CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
        ...
        function k(a) {
            ...
            } catch(g) {} (CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == d.document.$.compatMode) && this.attachListener(this, "keydown",
            function(a) {
                var b = a.data.getKeystroke();
        ...
        i.prototype = {
            onKeydown: function(a) {
                if ( - 1 < CKEDITOR.tools.indexOf(g, a.data.getKeystroke())) a.data.preventDefault();
                    ...
                    if (e.isNavigationKey(a) || this.undoManager.keyGroupChanged(a)) if (b.strokesRecorded[0] || b.strokesRecorded[1]) b.save(!1, this.lastKeydownImage, !1),
                    b.resetType()
                }
            },
            onInput: function() {
